...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   [BASE] = LAYOUT_all( /* Base */
        TD(GRV_TAP_DANCE) , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   , KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_MINS, KC_EQL , KC_BSPC, KC_HOME ,
        KC_TAB , KC_Q   , KC_W   , KC_E   , KC_R   , KC_T   , KC_Y   , KC_U   , KC_I   , KC_O   , KC_P   , KC_LBRC, KC_RBRC, KC_BSLS, KC_END,
        TD(ESC_TAP_DANCE), KC_A   , KC_S   , KC_D   , KC_F   , KC_G   , KC_H   , KC_J   , KC_K   , KC_L   , KC_SCLN, KC_QUOT,          KC_ENT , KC_PGUP,
...
void matrix_scan_user(void) {
  LEADER_DICTIONARY() {
    ...
    SEQ_TWO_KEYS(KC_END, KC_PGUP) {
      register_code(KC_SLEP);
    }
    SEQ_FOUR_KEYS(KC_END, KC_PGUP, KC_PGDN, KC_RGHT) {
